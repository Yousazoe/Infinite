...
void IcarusPlayer::LoadAssets()
{
	m_ShipTexture = Texture2D::Create("assets/textures/Ship.png");
}

void IcarusPlayer::OnUpdate(Infinite::Timestep ts)
{
	m_Time += ts;

	if (Input::IsKeyPressed(IFN_KEY_SPACE))
	{
